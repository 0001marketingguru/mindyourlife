    ...
    <section className="relative bg-[radial-gradient(ellipse_80%_60%_at_50%_-10%,#1A3A57_0%,#0B1B2B_55%)] text-silver overflow-hidden pt-8 md:pt-14">
      ...
      <div className="relative z-10 max-w-[1180px] mx-auto px-5 sm:px-8 pt-10 pb-12 md:pt-20 md:pb-20 grid grid-cols-1 md:grid-cols-[1.1fr_0.9fr] gap-8 md:gap-14 items-center text-center md:text-left">
        <div className="max-w-full md:max-w-[560px] mx-auto md:mx-0">
          ...
          <h1 className="text-[clamp(2rem,5.6vw,4rem)] font-display font-bold mb-5 leading-[1.05] tracking-tighter text-balance">
            Unlock Your Highest Potential with <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange to-mango">Battle-Tested Military Frameworks</span>.
          </h1>

          <p className="text-[16px] md:text-[17.5px] text-silver/80 max-w-full md:max-w-[540px] mb-9 leading-[1.6]">
        ...
        <div className="relative flex justify-center mb-10 md:mb-0 w-full max-w-[280px] sm:max-w-[340px] md:max-w-[440px] mx-auto md:mx-0">
          ...
          <div className="relative z-10 w-full">
            <motion.div
              ...
              className="relative rounded-2xl border border-white/10 bg-white/[0.02] p-1.5 backdrop-blur-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.1),0_20px_40px_-10px_rgba(0,0,0,0.4)]"
            >
              <img src="/assets/hero_visual.png" 
                alt="Param Workshop Visual" 
                className="w-full rounded-xl border border-white/5 bg-ink-soft/40 object-cover aspect-[4/3] md:aspect-[4/3]" />
            </motion.div>
          </div>
        </div>
      </div>
